 ...
 *
 */
var _Function = function (_Function, Test) { return __awaiter(void 0, void 0, void 0, function () {
    var Tests, _i, Test_1, _a, Key, Value, _b, _c, _d, Tests, _e, Test_2, El, _f, _g, Tests, _h, Test_3, Index, _j, _k;
    return __generator(this, function (_l) {
        switch (_l.label) {
            case 0:
                if (!(_Function instanceof Function)) return [3 /*break*/, 18];
            ...
            case 1:
                ...
                _c = (_b = Tests).set;
                return [4 /*yield*/, _Function(Key)];
            case 2:
                _d = [_l.sent()];
                return [4 /*yield*/, _Function(Value)];
            case 3:
            ...
            case 12:
                ...
                Index = Test_3[_h];
                _k = (_j = Tests).push;
                return [4 /*yield*/, _Function(Index)];
            case 13:
                _k.apply(_j, [_l.sent()]);
                _l.label = 14;
            case 14:
            ...
            case 16: return [4 /*yield*/, _Function(Test)];
