 ...
 */
var _Function = function (Search, From) { return __awaiter(void 0, void 0, void 0, function () {
    var Path, Original, _a, _b, _c, _Error_1;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("path"); })];
            case 1:
                Path = (_d.sent()).dirname(Search);
                Original = From ? From : Path;
                if (Path === Search) {
            ...
            case 3:
                _b = (_a = (_d.sent())).access;
                _c = ["".concat(Path, "/.git")];
                return [4 /*yield*/, Promise.resolve().then(function () { return require("fs"); })];
            case 4: return [4 /*yield*/, _b.apply(_a, _c.concat([(_d.sent()).constants.R_OK]))];
            case 5:
                _d.sent();
                return [2 /*return*/, Path];
            case 6:
                _Error_1 = _d.sent();
                return [4 /*yield*/, (0, exports._Function)(Path, Original)];
...
exports.default = exports._Function;
