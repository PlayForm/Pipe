...
exports.default = (function (Bytes, Decimals) {
    if (Decimals === void 0) { Decimals = 2.0; }
    return __awaiter(void 0, void 0, void 0, function () {
        var K, I;
        return __generator(this, function (_a) {
            if (Bytes === 0) {
                return [2 /*return*/, "0 Bytes"];
            }
            K = 1024;
            I = Math.floor(Math.log(Bytes) / Math.log(K));
            return [2 /*return*/, "".concat(parseFloat((Bytes / Math.pow(K, I)).toFixed(Decimals < 0 ? 0 : Decimals)), " ").concat(["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][I])];
        });
    });
});
