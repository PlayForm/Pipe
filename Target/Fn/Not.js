 ...
 */
exports.default = (function (Pattern, Files) { return __awaiter(void 0, void 0, void 0, function () {
    var Filters, _i, Pattern_1, Patterns, _a, Filters_1, Filter, _b, Files_1, File_1;
            ...
            for (_b = 0, Files_1 = Files; _b < Files_1.length; _b++) {
                ...
                switch (true) {
                    case typeof Filter === "string": {
                        if (File_1[0].match(Filter) ||
                            File_1[1].match(Filter)) {
                            Files.delete(File_1[0]);
                        }
                        break;
                    }
