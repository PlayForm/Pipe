class o {
	In = async (...[t]) => {
		for (const [a, s] of await (await import("../Function/In.js")).default(
			t,
			this.Plan.Paths,
		))
			this.Plan.Paths.set(a, s);
		return this;
	};
	By = async (...[t]) => (
...
const {
		default: { Cache: i, Logger: n, Action: r },
	} = await import("../Variable/Option.js"),
	{ default: e } = await import(
		"typescript-esbuild/Target/Function/Merge.js"
	);
export { r as Action, i as Cache, n as Logger, e as Merge, o as default };
